...
## [Matrix102](https://github.com/TrooperZ/CSA_Assignments/tree/main/Lab_Assignments/Cycle4/Matrix102)

Objective:

- Write a method (`flipHorizontal`) that takes a 2D array and flips the elements horizontally
- Write a method (`flipVertical`) that takes a 2D array and flips the elements vertically.
- Write a method (`transpose`) that flips elements through the major diagonal.
- Write a method (`reflectDiagonal2`) that flips elements through the minor diagonal.
